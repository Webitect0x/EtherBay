defmodule EtherBayApi.AccountsTest do
  use EtherBayApi.DataCase

  alias EtherBayApi.Accounts
  ...
  describe "accounts" do
    ...
    test "create_account/1 with valid data creates a account" do
      valid_attrs = %{username: "some username", password: "some password", bio: "some bio", account_status: "some account_status"}
    ...
    test "update_account/2 with valid data updates the account" do
      account = account_fixture()
      update_attrs = %{username: "some updated username", password: "some updated password", bio: "some updated bio", account_status: "some updated account_status"}
